...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(package='grasp_demo_pkg', executable='plan_to_pose_node', name='plan_to_pose_node', parameters=[params], output='screen'),
        TimerAction(period=3.0, actions=[
            Node(package='grasp_demo_pkg', executable='pick_place_state_machine', name='perception_pipeline_state_machine', parameters=[params], output='screen')
        ]),
    ])
